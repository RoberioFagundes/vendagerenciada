...
class CreateProdutoFamarciaCartelaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('produto_famarcia_cartela', function (Blueprint $table) {
            ...
            $table->decimal('QTD_PRODUTO_CARTELA', 10, 2)->nullable();
            ...
            $table->foreign('USER_ID', 'produto_famarcia_cartela_ibfk_1')->references('id')->on('users')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('categoria_id', 'produto_famarcia_cartela_ibfk_2')->references('id')->on('categorias')->onDelete('cascade')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('produto_famarcia_cartela');
    }
}
