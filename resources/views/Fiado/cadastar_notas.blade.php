...
<div class="card mt-4 mb-6 border-light shadow">
    ...
    <form action="{{route('save_post')}}" method="post">
        ...
        <select class="form-control" name="cliente_id" id="cliente_id">
            ...
            <option value="{{$c->id}}">{{$c->nomeCliente}}</option>
        ...
        <input class="form-control" type="date" name="dataNota">
        <br>
        ...
        <input class="form-control" type="date" name="vencimento" id="vencimento"><br>
