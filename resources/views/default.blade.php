                ...
                <ul class="nav">
                    <li class="active">
                        <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <img src="{{asset("public/img/caixa-registradora.png")}}" width="50px" height="50px"
                                srcset="">Caixa
                        </a>
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                            <li class="nav">
                                <a class="nav-link" href="{{ route('entradasaida_index') }}">
                                    Saldo
                                </a>
                            </li>
                            <li class="nav">
                                <a class="nav-link" href="{{ route('deposito_novo') }}">
                                    Novo Deposito
                                </a>
                            </li>

                            <li class="nav">
                                <a class="nav-link" href="{{ route('saque_novo') }}">
                                    Novo Saque
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('produto_cartela_novo')}}">Produtos com
                                        cartela</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false"
                            ...
                            <img src="{{asset("public/img/atendimento-ao-cliente.png")}}" width="50px" height="50px"
                                srcset="">
                            <span class="menu-title">Notas Fiado</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('index_fiado')}}">Lista de
                                        notas</a></li>
