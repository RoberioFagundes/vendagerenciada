...
@section('body')
	...
	<div class="card w-75  mt-3 mb-4 border-light shadow">
		...
		<div class="card-body">
			<form action="{{ route('index_produto_unidade') }}">
				<div class="row">
					...
					<div class="col-md-8 col-sm-8 mt-3 pt-4">
						...
						<a href="{{ route('index_produto_unidade') }}" class="btn btn-warning btn-sm">Limpar</a>
					</div>
	...
	<div class="card mt-4 mb-6 border-light shadow" >
		...
		<div class="card-header d-flex justify-content-between">
			<span>Listar de produtos com unidade</span>
		</div>
				...
				<tbody>
					@forelse ($produtos as $p)
						<tr>
							...
							<td>
							<form id="form-delete" action="produtosfamarciaUnidade/produtofamarciaUnidadedelete/{{$p->id}}" method="POST">
									{{ csrf_field() }}
									{{ method_field('DELETE') }}
							...
							<td class="d-md-flex justify-content-center">
									...
									<a class="btn btn-sm btn-warning" href="produtosfamarciaUnidade/produtofamarciaUnidadeedit/{{$p->id}}">
