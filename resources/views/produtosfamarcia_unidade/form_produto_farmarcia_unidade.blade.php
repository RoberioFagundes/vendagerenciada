...
<div class="col-xl-12">
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{route('produto_unidade_save')}}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <select name="categoria_id"
                            ...
                            <option @isset($produto)@if($produto->categoria_id == $c->id) selected @endif @else
                                @if(old('categoria_id') == $c->id) selected @endif @endif value="{{$c->id}}">
                                {{$c->nome}}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputQTD_PRODUTO"
                            placeholder="Campo de preenchimento Obrigátorio" name="inputQTD_PRODUTO">
                        <label id="label-QTD-PRODUTO" class="alert alert-danger" style="display:none;">A quantidade de
                            produtos é obrigatória</label>
                    </div>

                    <div class="form-group col-xl-4">
                        <label>Quantidade de unidade do produto na caixa</label>
                    ...
                    <div class="form-group col-xl-4">
                        <label>valor do produto com caixa completa</label>
                        <input type="text" class="form-control" id="inputvalor_produto"
                            placeholder="Campo de preenchimento Obrigátorio" name="inputvalor_produto">
                        <label id="label-vlr-produto" class="alert alert-danger" style="display:none;">O valor do
                            produtos é obrigatório</label>
                    </div>

                    <div class="form-group col-xl-4">
                        <label>Valor de venda com caixa completa</label>
                        <input type="text" class="form-control" id="inputvalor_venda"
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputvalor_venda_unidade"
                            placeholder="Campo de preenchimento Opcional" name="inputvalor_unitario">
                        <label id="label-valor-venda" class="alert alert-danger" style="display:none;">O valor de venda
                            é obrigatório</label>
                    </div>
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputindicacao"
                            placeholder="Campo de preenchimento Opcional" name="inputindicacao">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>substância</label>
                        <input type="text" class="form-control" id="inputsubstancia"
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputapresentacao"
                            placeholder="Campo de preenchimento Opcional" name="inputapresentacao">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>classe Terapeutica</label>
                        <input type="text" class="form-control" id="inputclasseTerapeutica"
                            placeholder="Campo de preenchimento Opcional" name="inputclasseTerapeutica">
                    </div>
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputregimePreco"
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputPMC_Sem_Impostos"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC_Sem_Impostos">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC</label>
                        <input type="text" class="form-control" id="inputPMC"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC 12%</label>
                        <input type="text" class="form-control" id="inputPMC_12"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC_12">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC 12 ALC</label>
                        <input type="text" class="form-control" id="inputPMC_12_ALC"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC_12_ALC">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC 17</label>
                        <input type="text" class="form-control" id="inputPMC_17"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC_17">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC 17 ALC</label>
                        <input type="text" class="form-control" id="inputPMC_17_ALC"
                            placeholder="Campo de preenchimento Opcional" name="inputPMC_17_ALC">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>PMC 17,5</label>
                        <input type="text" class="form-control" id="inputPMC_17_5"
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputrestricao_hospital"
                            placeholder="Campo de preenchimento Opcional" name="inputrestricao_hospital">
                    </div>
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputCONFAZ_87"
                            placeholder="Campo de preenchimento Opcional" name="inputCONFAZ_87">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>ICMS 0</label>
                        <input type="text" class="form-control" id="inputICMS_0"
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputANÁLISE_RECURSAL"
                            placeholder="Campo de preenchimento Opcional" name="inputANÁLISE_RECURSAL">
                    </div>
                    ...
                    <div class="form-group col-xl-4">
                        ...
                        <input type="text" class="form-control" id="inputCOMERCIALIZAÇAO_2022"
                            placeholder="Campo de preenchimento Opcional" name="inputCOMERCIALIZAÇAO_2022">
                    </div>

                    <div class="form-group col-xl-4">
                        <label>TARJA</label>
                        <input type="text" class="form-control" id="inputTARJA"
