...
SUM(vendas.valor) as valortotal
       ...
       produto_famarcia_unidades.id=itemvendas_unidade.produtofarmaciaUnidade_id and
        fatura_vendas.venda_id=vendas.id and users.id=1 AND DATE(vendas.created_at)=CURRENT_DATE"); //consulta para mostrar usuarios horario de vendas
       ...
       produto_famarcia_unidades.id=itemvendas_unidade.produtofarmaciaUnidade_id and
        ...
        foreach ($valortotalCaixaSemClienteManha as $ValortotalCaixaSemClienteManha) {
            $valortotalCaixaDiaSemClienteManhaClienteDias = floatval($ValortotalCaixaSemClienteManha->valortotal);//caixa
        }


        foreach ($valortotalVendaUnidadeSemClientePerimetroManhaDia as $ValortotalVendaUnidadeSemClientePerimetroManhaDia) {
            $ValortotalVendaUnidadeSemClientePerimetroManhaDias = floatval($ValortotalVendaUnidadeSemClientePerimetroManhaDia->valortotal);
        }
        ...
        $DayCaixaManha = floatval($valortotalCaixaDiaSemClienteManhaClienteDias);
        // dd($valortotalVendaCartelaSemClientePerimetroManhaDay);
        $DayUnidadeManha = floatval($ValortotalVendaUnidadeSemClientePerimetroManhaDias);
    ...
    { //função correta
        ...
        try {
            ...
            // }
            $titulo = 'Nova venda';
            return view('vendas/form', compact('titulo', 'clientes', 'produtos', 'produtosUnidade', 'produtoCartela'));
        } catch (\Exception $e) {
