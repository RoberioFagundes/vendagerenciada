...
{
    //
    public function index_produto_famarcia_cartela()
    {
       
        $produtos = User::join('produto_famarcia_cartela', 'produto_famarcia_cartela.user_id', '=', 'users.id')->where('users.id', auth()->user()->id)->get();

        $titulo = 'Medicamento com cartela';
       
        return view('produto_famarcia_cartela.index_produto_farmacia_cartela', compact('titulo', 'produtos'));
    }
    ...
    public function edit_produto_famarcia_cartela($id)
    {
        try{
			...
			$produto = User::join('produto_famarcia_cartela', 'produto_famarcia_cartela.user_id', '=', 'users.id')->where('users.id', auth()->user()->id)->get()->find($id);
			$categorias = User::join('categorias', 'categorias.user_id', '=', 'users.id')->where('users.id',auth()->user()->id)->get();
