 ...
 * @property float|null $valor_produto
 * @property int|null $USER_ID
 * @property float|null $valor_unitario
 * 
 * @property User|null $user
 * @property Categoria|null $categoria
 * @property Collection|ItemvendasUnidade[] $itemvendas_unidades
 *
 * @package App\Models
 */
class ProdutoFamarciaUnidade extends Model
{
	protected $table = 'produto_famarcia_unidades';
	...
	public function itemvendas_unidades()
	{
		return $this->hasMany(ItemvendasUnidade::class, 'produtofarmaciaUnidade_id');
	}
}
