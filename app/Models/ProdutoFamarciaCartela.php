 ...
 * @property float|null $QTD_PRODUTO_CARTELA
 ...
 * @package App\Models
 */
class ProdutoFamarciaCartela extends Model
{
	protected $table = 'produto_famarcia_cartela';
